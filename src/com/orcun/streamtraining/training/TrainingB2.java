...
public class TrainingB2 {
	...
	//TODO: Найти пользователя с максимальным возрастом (используйте max с Comparator.comparingInt)
	...
	public static void main(String[] args) {
		...
		TrainingB2 training = new TrainingB2();
		
		User expected = training.getOldestUserV1(userList);
		User actual = training.getOldestUserV2(userList);
