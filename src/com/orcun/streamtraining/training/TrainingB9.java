...
public class TrainingB9 {
	...
	public static void main(String[] args) {
		...
		TrainingB9 training = new TrainingB9();
		
		Map<Boolean,List<User>> expected = training.groupEngineersByIsVegetarianV1(userList);
		Map<Boolean,List<User>> actual = training.groupEngineersByIsVegetarianV2(userList);
